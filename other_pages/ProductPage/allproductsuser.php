                        ...
                        <?php foreach ($products as $product): ?>
                            <div class="col-md-4 mb-4">
                                <div class="card h-100">
                                    <img src="<?= htmlspecialchars(assetImageSrc((string)$product["image"], 'product'), ENT_QUOTES) ?>" class="card-img-top" alt="<?= htmlspecialchars($product["name"], ENT_QUOTES) ?>">
                                    <div class="card-body">
                                        ...
                                        <?php endif; ?>
                                        <a href="view_product.php?product=<?= htmlspecialchars($product["slug"], ENT_QUOTES) ?>" class="btn btn-primary">View Product</a>
                                    </div>
                                </div>
                            </div>
                        <?php endforeach; ?>
...
<script>
    function updateSortOrder(sortOrder) {
        ...
        window.location.href = `allproductsuser.php?category=${category}&sort_order=${sortOrder}`;
    }
</script>
</body>
</html>
