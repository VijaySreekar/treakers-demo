...
if(isset($_GET['category']))
{
    ...
    $category = getSlugActive('category', $category_slug);
    ...
    ?>
        ...
        <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg">
            ...
            <nav class="breadcrumbs">
                ...
                <a href="../ProductPage/products_page.php" class="breadcrumbs__item is-active"><i class="bi bi-box"></i><?= htmlspecialchars((string)$category['name']) ?></a>
            </nav>
            ...
            <div class="py-3">
                <div class="container">
                    <div class="row">
                        <div class="col-md-12">
                            <h1>Category: <?= htmlspecialchars((string)$category['name']); ?></h1>
                            <hr>
                            <div class="row">
                                ...
                                if (count($products) > 0) {
                                    foreach ($products as $item) {
                                        ...
                                        <div class="col-md-3 mb-3">
                                            <a href="view_product.php?product=<?= htmlspecialchars((string)$item['slug'], ENT_QUOTES); ?>">
                                                <div class="card shadow">
                                                    <div class="card-body">
                                                        <img src="<?= htmlspecialchars(assetImageSrc((string)$item['image'], 'product'), ENT_QUOTES); ?>" alt="Product Image" class="w-100">
                                                        <h4 class="text-center"><?= htmlspecialchars((string)$item['name']); ?></h4>
                                                    </div>
                                                </div>
                                            </a>
                                        </div>
