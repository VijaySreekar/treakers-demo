                                    ...
                                    foreach ($category as $item) {
                                        ?>
                                            <div class="col-md-3 mb-3">
                                                <a href="products_page.php?category=<?= htmlspecialchars((string)$item['slug'], ENT_QUOTES); ?>">
                                                    <div class="card shadow">
                                                        <div class="card-body">
                                                            <img src="<?= htmlspecialchars(assetImageSrc((string)$item['image'], 'category'), ENT_QUOTES); ?>" alt="Category Image" class="w-100">
