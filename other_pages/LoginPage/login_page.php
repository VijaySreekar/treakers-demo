    ...
    <script>
        $(document).ready(function () {
            $("#login-form").on("submit", function (event) {
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        ...
                        $("#error-message").text((response && response.message) ? response.message : "Login failed.");
                    },
                    error: function () {
            ...
            $("#signup-form").on("submit", function (event) {
                event.preventDefault();
                $("#signup-error-message").css("color", "red").text("");
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        if (response && response.success) {
                            $("#signup-error-message").css("color", "green").text(response.message || "Registration successful. Please log in.");
                            $("#change").prop("checked", false); // Switch back to login view
                            return;
                        }

                        $("#signup-error-message").text((response && response.message) ? response.message : "Registration failed.");
                    },
                    error: function () {
                        $("#signup-error-message").text("Registration failed. Please try again.");
                    }
                });
            });
        });
